...
from_StartFeedback_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v170 -> P.Just (1, ("results",from_SearchResult _v170))) $ startFeedback_args_results record
  ]
...
to_StartFeedback_args (T.TStruct fields) = StartFeedback_args{
  startFeedback_args_results = P.maybe (startFeedback_args_results default_StartFeedback_args) (\(_,_val172) -> (case _val172 of {T.TStruct _val173 -> (to_SearchResult (T.TStruct _val173)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_StartFeedback_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v176 -> (1, ("ex",Services_Types.from_ServicesException _v176))) <$> startFeedback_result_ex record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v176 -> (1, ("ex",Services_Types.from_ServicesException _v176))) <$> startFeedback_result_ex record
    ]
    )
...
to_StartFeedback_result (T.TStruct fields) = StartFeedback_result{
  startFeedback_result_ex = P.maybe (P.Nothing) (\(_,_val178) -> P.Just (case _val178 of {T.TStruct _val179 -> (Services_Types.to_ServicesException (T.TStruct _val179)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_AddCommunicationFeedback_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v182 -> P.Just (1, ("searchResultsId",Uuid_Types.from_UUID _v182))) $ addCommunicationFeedback_args_searchResultsId record
  , (\_v182 -> P.Just (2, ("communicationId",T.TString $ E.encodeUtf8 _v182))) $ addCommunicationFeedback_args_communicationId record
  , (\_v182 -> P.Just (3, ("feedback",T.TI32 $ P.fromIntegral $ P.fromEnum _v182))) $ addCommunicationFeedback_args_feedback record
  ]
...
to_AddCommunicationFeedback_args (T.TStruct fields) = AddCommunicationFeedback_args{
  addCommunicationFeedback_args_searchResultsId = P.maybe (addCommunicationFeedback_args_searchResultsId default_AddCommunicationFeedback_args) (\(_,_val184) -> (case _val184 of {T.TStruct _val185 -> (Uuid_Types.to_UUID (T.TStruct _val185)); _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  addCommunicationFeedback_args_communicationId = P.maybe (addCommunicationFeedback_args_communicationId default_AddCommunicationFeedback_args) (\(_,_val184) -> (case _val184 of {T.TString _val186 -> E.decodeUtf8 _val186; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  addCommunicationFeedback_args_feedback = P.maybe (addCommunicationFeedback_args_feedback default_AddCommunicationFeedback_args) (\(_,_val184) -> (case _val184 of {T.TI32 _val187 -> P.toEnum $ P.fromIntegral _val187; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_AddCommunicationFeedback_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v190 -> (1, ("ex",Services_Types.from_ServicesException _v190))) <$> addCommunicationFeedback_result_ex record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v190 -> (1, ("ex",Services_Types.from_ServicesException _v190))) <$> addCommunicationFeedback_result_ex record
    ]
    )
...
to_AddCommunicationFeedback_result (T.TStruct fields) = AddCommunicationFeedback_result{
  addCommunicationFeedback_result_ex = P.maybe (P.Nothing) (\(_,_val192) -> P.Just (case _val192 of {T.TStruct _val193 -> (Services_Types.to_ServicesException (T.TStruct _val193)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_AddSentenceFeedback_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v196 -> P.Just (1, ("searchResultsId",Uuid_Types.from_UUID _v196))) $ addSentenceFeedback_args_searchResultsId record
  , (\_v196 -> P.Just (2, ("communicationId",T.TString $ E.encodeUtf8 _v196))) $ addSentenceFeedback_args_communicationId record
  , (\_v196 -> P.Just (3, ("sentenceId",Uuid_Types.from_UUID _v196))) $ addSentenceFeedback_args_sentenceId record
  , (\_v196 -> P.Just (4, ("feedback",T.TI32 $ P.fromIntegral $ P.fromEnum _v196))) $ addSentenceFeedback_args_feedback record
  ]
...
to_AddSentenceFeedback_args (T.TStruct fields) = AddSentenceFeedback_args{
  addSentenceFeedback_args_searchResultsId = P.maybe (addSentenceFeedback_args_searchResultsId default_AddSentenceFeedback_args) (\(_,_val198) -> (case _val198 of {T.TStruct _val199 -> (Uuid_Types.to_UUID (T.TStruct _val199)); _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  addSentenceFeedback_args_communicationId = P.maybe (addSentenceFeedback_args_communicationId default_AddSentenceFeedback_args) (\(_,_val198) -> (case _val198 of {T.TString _val200 -> E.decodeUtf8 _val200; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  addSentenceFeedback_args_sentenceId = P.maybe (addSentenceFeedback_args_sentenceId default_AddSentenceFeedback_args) (\(_,_val198) -> (case _val198 of {T.TStruct _val201 -> (Uuid_Types.to_UUID (T.TStruct _val201)); _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  addSentenceFeedback_args_feedback = P.maybe (addSentenceFeedback_args_feedback default_AddSentenceFeedback_args) (\(_,_val198) -> (case _val198 of {T.TI32 _val202 -> P.toEnum $ P.fromIntegral _val202; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_AddSentenceFeedback_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v205 -> (1, ("ex",Services_Types.from_ServicesException _v205))) <$> addSentenceFeedback_result_ex record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v205 -> (1, ("ex",Services_Types.from_ServicesException _v205))) <$> addSentenceFeedback_result_ex record
    ]
    )
...
to_AddSentenceFeedback_result (T.TStruct fields) = AddSentenceFeedback_result{
  addSentenceFeedback_result_ex = P.maybe (P.Nothing) (\(_,_val207) -> P.Just (case _val207 of {T.TStruct _val208 -> (Services_Types.to_ServicesException (T.TStruct _val208)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
