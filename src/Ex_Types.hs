...
from_ConcreteThriftException record = T.TStruct $ Map.fromList $ M.catMaybes
  ...
  , (\_v2 -> (2, ("serEx",T.TString _v2))) <$> concreteThriftException_serEx record
  ]
...
to_ConcreteThriftException (T.TStruct fields) = ConcreteThriftException{
  ...
  concreteThriftException_serEx = P.maybe (P.Nothing) (\(_,_val4) -> P.Just (case _val4 of {T.TString _val6 -> _val6; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
typemap_ConcreteThriftException = Map.fromList [(1,("message",T.T_STRING)),(2,("serEx",T.T_STRING))]
