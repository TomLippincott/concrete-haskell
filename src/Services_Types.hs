...
data AnnotationTaskType = TRANSLATION|NER  deriving (P.Show, P.Eq, G.Generic, TY.Typeable, P.Ord, P.Bounded)
...
from_ServicesException record = T.TStruct $ Map.fromList $ M.catMaybes
  ...
  , (\_v2 -> (2, ("serEx",T.TString _v2))) <$> servicesException_serEx record
  ]
...
to_ServicesException (T.TStruct fields) = ServicesException{
  ...
  servicesException_serEx = P.maybe (P.Nothing) (\(_,_val4) -> P.Just (case _val4 of {T.TString _val6 -> _val6; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
typemap_ServicesException = Map.fromList [(1,("message",T.T_STRING)),(2,("serEx",T.T_STRING))]
...
from_NotImplementedException record = T.TStruct $ Map.fromList $ M.catMaybes
  ...
  , (\_v9 -> (2, ("serEx",T.TString _v9))) <$> notImplementedException_serEx record
  ]
...
to_NotImplementedException (T.TStruct fields) = NotImplementedException{
  ...
  notImplementedException_serEx = P.maybe (P.Nothing) (\(_,_val11) -> P.Just (case _val11 of {T.TString _val13 -> _val13; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
typemap_NotImplementedException = Map.fromList [(1,("message",T.T_STRING)),(2,("serEx",T.T_STRING))]
