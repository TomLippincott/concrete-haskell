...
from_Sound record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2 -> (1, ("wav",T.TString _v2))) <$> sound_wav record
  , (\_v2 -> (2, ("mp3",T.TString _v2))) <$> sound_mp3 record
  , (\_v2 -> (3, ("sph",T.TString _v2))) <$> sound_sph record
...
to_Sound (T.TStruct fields) = Sound{
  sound_wav = P.maybe (P.Nothing) (\(_,_val4) -> P.Just (case _val4 of {T.TString _val5 -> _val5; _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  sound_mp3 = P.maybe (P.Nothing) (\(_,_val4) -> P.Just (case _val4 of {T.TString _val6 -> _val6; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  sound_sph = P.maybe (P.Nothing) (\(_,_val4) -> P.Just (case _val4 of {T.TString _val7 -> _val7; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
...
typemap_Sound = Map.fromList [(1,("wav",T.T_STRING)),(2,("mp3",T.T_STRING)),(3,("sph",T.T_STRING)),(4,("path",T.T_STRING))]
default_Sound :: Sound
default_Sound = Sound{
  sound_wav = P.Nothing,
  sound_mp3 = P.Nothing,
